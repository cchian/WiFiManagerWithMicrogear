 ...
 * 
 // Message ที่จะสั่งงาน อุปกรณ์นี้ จะมีอยู่ 5 เคส ด้านล่าง ใช้ได้ทั้งในส่วนของ Netpie Microgear และ Serial สำหรับสั่งงานบอร์ด Arduino ซึ่งการสั่งงานบอร์ด Arduino นี้ตัว ESP8266 จะทำหน้าที่เอง
 // {x}=!          | x คือแชลแนลที่ต้องการ ! หมายถึงกลับสถานะระหว่าง ON|OFF
