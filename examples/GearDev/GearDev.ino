...
/*esp มีหน้าที่อัพเดท STA ไปให้บอร์ด arduino ไม่ให้ arduino เช็คว่า STA มีค่าเป็น 0
  บอร์ด Arduino จะวิเคราะห์ ถ้า STA มีค่า เป็น 0 แสดงว่า esp8266 ไม่ยอส่งสวยหรือบกพร่องในการทำงาน
  Arduino ก็จะทำการประหาร esp8266 ทันที เพื่อให้ esp8266 ทำงานเป็นปกติเหมือนเดิมนั่นเอง
*/
int sta_running_duration = (1000*30); // 5 นาที
